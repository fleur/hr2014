...
describe("About Applying What We Have Learnt", function() {
  ...
  it("given I'm allergic to nuts and hate mushrooms, it should find a pizza I can eat (functional)", function () {
      ...
      productsICanEat = products.filter(function(value) {
          return (value.containsNuts == false) && !value.ingredients.some(function(element) { return element == "mushrooms"; });
      });
  ...
  it("should count the ingredient occurrence (functional)", function () {
    ...
    var rv = _.chain(products)
              .map(function(element) { return element.ingredients; })
              .flatten()
              .reduce(function(sum, val) { 
                  sum[val] = (sum[val] == undefined) ? 1 : sum[val]+1; 
                  return sum;
                  }, ingredientCount)
              .value();
